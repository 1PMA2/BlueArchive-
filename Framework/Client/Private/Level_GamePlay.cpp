...
HRESULT CLevel_GamePlay::Ready_Layer_Camera(const _tchar * pLayerTag)
{
	...
	CameraDesc.fFovy = XMConvertToRadians(18.0f);
...
HRESULT CLevel_GamePlay::Ready_Layer_BackGround(const _tchar * pLayerTag)
{
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, pLayerTag, TEXT("Prototype_GameObject_Sky_Ex"))))
		return E_FAIL;
...
HRESULT CLevel_GamePlay::Ready_Layer_Trigger(const _tchar * pLayerTag)
{
	...
	//55
	vTranslation = XMVectorSet(1.2f, 0.f, 6.f, 1.f);
...
HRESULT CLevel_GamePlay::Ready_Layer_Cover(const _tchar * pLayerTag)
{
	...
	vTranslation = XMVectorSet(1.4f, 0.f, 48.5f, 1.f);

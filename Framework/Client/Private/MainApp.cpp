...
HRESULT CMainApp::Render()
{
	...
	m_pGameInstance->Clear_BackBuffer_View(_float4(222.f/255.f, 250.f/255.f, 251.f/255.f, 1.f));
...
HRESULT CMainApp::Ready_Prototype_Component()
{
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_RectX"),
		CVIBuffer_RectX::Create(m_pDevice, m_pContext))))
		return E_FAIL;

...
class CKayoko final : public CStudent
{
public:
	CKayoko(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CKayoko(const CKayoko& rhs);
	virtual ~CKayoko() = default;
...
public:
	static CKayoko* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);

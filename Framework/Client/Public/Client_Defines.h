...
namespace Client 
{
	...
	enum FORMATION {FORMATION_FIRST, FORMATION_FIRST_EX, FORMATION_SECOND, FORMATION_SECOND_EX, FORMATION_THIRD, FORMATION_THIRD_EX, FORMATION_FOURTH, FORMATION_FOURTH_EX, FORMATION_END};
	enum UNIT_STATE {UNIT_IDLE, UNIT_END};
	enum ANIM {
		ANIM_EX, ANIM_EXCUTIN, ANIM_FORMATIONIDLE, ANIM_FORMATIONPICK, ANIM_KNEEZOOM, ANIM_HIDERELOADSTART, ANIM_FIRE, ANIM_HIDERELOADEND, ANIM_HIDESIGN, ANIM_HIDEIDLE, ANIM_HIDERELOADING, ANIM_RUNSIGN, ANIM_RUNTOHIDE, ANIM_RUNTOKNEE,
